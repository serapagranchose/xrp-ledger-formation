...
import { Account, Networks, XRPLClient, getBalances } from "@nice-xrpl/react-xrpl";
import { Wallet } from "@nice-xrpl/react-xrpl";

function LoginModal({ isOpen, onClose } : { isOpen: any, onClose: any }) {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      ...
                      {/* <Wallet seed="sEdVRJhxG6pdCEXdhs3kCtXZxTYCDV5"> */}
                      {/* </Wallet> */}
                    </p>
                  </div>
                </div>
