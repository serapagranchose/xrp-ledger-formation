...
import LoginModal from "../buttons/login/index";
        ...
        <div className="flex items-center lg:order-2">
          ...
          <div className={`${isNavbarToggle ? 'none' : 'hidden'} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`}>
            <ul className="flex flex-col mt-4 lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <Link href="/login" onClick={toggleMobileNavbar} className="block py-2 pr-4 pl-3 hover:text-gray-400 lg:dark:hover:bg-transparent">Login</Link>
              </li>
            </ul>
          </div>
